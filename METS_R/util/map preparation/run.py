...
def main(input_folder, output_folder = 'ouptput/', cache_res=False, start_phase = 1):
    ...
    if(start_phase <= 3):
        ...
        name3=input_folder+'NYC_joined_correctedbridges.gpkg'
        if cache_res:
    ...
    if(start_phase <= 4):
        ...
        df4=reduc_shp_direc(df4)
        df4=reduc_shp_direc(df4)
        name4=input_folder+'NYC_joined_correctedbridges_red.gpkg'
        if cache_res:
    ...
    if(start_phase <= 5):
        ...
        name5=input_folder+'NYC_joined_correctedbridges_red_strong.gpkg'
        if cache_res:
    ...
    if(start_phase <= 6):
        ...
        name6=input_folder+'NYC_joined_correctedbridges_red_4legs_strong.gpkg'
        if cache_res:
    ...
    if(start_phase <= 7):
        ...
        name7=input_folder+'NYC_joined_correctedbridges_red_4legs_strong_sim.gpkg'
        if cache_res:
