...
# Copyright (c) UMNILAB.
# The structure of this script is based on the original netconvert_carla.py script for SUMO.
#
# This work is licensed under the terms of the MIT license.
# For a copy, see <https://opensource.org/licenses/MIT>.
"""
Script to generate METS-R networks from CARLA maps
"""
...
# -- topology --------------------------------------------------------------------------------------
# ==================================================================================================
class METSTopology(object):
    """
    This object holds the topology of a METS-R net. Internally, the information is structured as
    follows:
        - road_list: {
