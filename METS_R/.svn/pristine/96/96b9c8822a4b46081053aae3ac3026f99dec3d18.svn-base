...
File: DoubleGraphToObjectGraphAdapter.java 
...
final class DoubleGraphToObjectGraphAdapter<N extends GObject> implements ObjectGraph<N, Double> {

  private final DoubleGraph<N> g;

  DoubleGraphToObjectGraphAdapter(DoubleGraph<N> g) {
    this.g = g;
  }
  ...
  @Override
  public Double getEdgeData(GNode<N> src, GNode<N> dst, byte nodeFlags, byte dataFlags) {
