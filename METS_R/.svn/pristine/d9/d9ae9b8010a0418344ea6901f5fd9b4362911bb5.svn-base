...
File: LongGraphToObjectGraphAdapter.java 
...
final class LongGraphToObjectGraphAdapter<N extends GObject> implements ObjectGraph<N, Long> {

  private final LongGraph<N> g;

  LongGraphToObjectGraphAdapter(LongGraph<N> g) {
    this.g = g;
  }
  ...
  @Override
  public Long getEdgeData(GNode<N> src, GNode<N> dst, byte nodeFlags, byte dataFlags) {
