...
public class BinaryTrajectoryOutputWriter implements DataConsumer {
	...
	private FrameSummary createFrameSummary(TickSnapshot tick, ArrayList<EVSnapshot> privateEvs,
			ArrayList<ETaxiSnapshot> occupiedTaxis, ArrayList<ETaxiSnapshot> relocationTaxis,
			ArrayList<ETaxiSnapshot> chargingTaxis, ArrayList<BusSnapshot> buses) {
