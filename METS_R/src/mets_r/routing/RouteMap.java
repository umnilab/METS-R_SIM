...
/**
 * 
 * Route matrix stores the routing information in a map the map is organised as
 * follows src_junc,dest_junc -> array of linkIDs key : src_junc_ID,dest_junc_ID
 * (as a string) value : array of linkIDs
 * 
