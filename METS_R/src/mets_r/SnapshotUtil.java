...
public class SnapshotUtil {
	...
	public static HashMap<String, Object> snapshotZone(Zone z) {
		...
		m.put("taxiPickupPassengers", z.taxiPickupPassengers);
		m.put("busPickupPassengers", z.busPickupPassengers);
		m.put("taxiPickedUpRequest", z.taxiPickedUpRequest);
		m.put("busPickedUpRequest", z.busPickedUpRequest);
		m.put("taxiPickedUpPassengers", z.taxiPickedUpPassengers);
		m.put("busPickedUpPassengers", z.busPickedUpPassengers);
		m.put("taxiServedRequest", z.taxiServedRequest);
		m.put("busServedRequest", z.busServedRequest);
		m.put("taxiServedPassengers", z.taxiServedPassengers);
		m.put("busServedPassengers", z.busServedPassengers);
	...
	private static void restoreZoneSnapshot(Zone z, HashMap<String, Object> zs) {
		...
		z.taxiPickupPassengers = toInt(zs.get("taxiPickupPassengers"));
		z.busPickupPassengers = toInt(zs.get("busPickupPassengers"));
		z.taxiPickedUpRequest = toInt(zs.get("taxiPickedUpRequest"));
		z.busPickedUpRequest = toInt(zs.get("busPickedUpRequest"));
		z.taxiPickedUpPassengers = toInt(zs.get("taxiPickedUpPassengers"));
		z.busPickedUpPassengers = toInt(zs.get("busPickedUpPassengers"));
		z.taxiServedRequest = toInt(zs.get("taxiServedRequest"));
		z.busServedRequest = toInt(zs.get("busServedRequest"));
		z.taxiServedPassengers = toInt(zs.get("taxiServedPassengers"));
		z.busServedPassengers = toInt(zs.get("busServedPassengers"));
