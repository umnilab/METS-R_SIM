...
/**
 * The implementation of Graph Growing Partitioning algorithm (GGP) Start from a
 * vertex and grow a region around it in a breath-first fashion, until half of
 * the vertices have been included
 */
