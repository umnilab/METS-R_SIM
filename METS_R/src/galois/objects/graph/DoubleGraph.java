...
/**
 * Interface used to represent graphs whose edges contain double data. <br/>
 * Edges can be created <b>only</b> by invoking {@link ObjectGraph#addEdge}: invocations of
 * {@link Graph#addNeighbor(GNode, GNode)} will result in an exception, because no edge data has been specified.
 *
 * @param <N> the type of the object stored in each node
 */
public interface DoubleGraph<N extends GObject> extends Graph<N> {
  /**
