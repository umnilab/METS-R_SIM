...
File: ObjectGraphToFloatGraphAdapter.java 
...
final class ObjectGraphToFloatGraphAdapter<N extends GObject> implements FloatGraph<N> {

  private final ObjectGraph<N, Float> g;

  ObjectGraphToFloatGraphAdapter(ObjectGraph<N, Float> g) {
    this.g = g;
  }
