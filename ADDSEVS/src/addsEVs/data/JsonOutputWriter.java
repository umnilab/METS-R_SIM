...
//        }
    ...
    public static HashMap<String, Object> createTickLines(TickSnapshot tick) {
		...
		if (tick == null) {
			...
			tickArray.put("ev", new ArrayList<ArrayList<Float>>());
		...
		// ArrayList<ArrayList<Double>> tickArray = new
		// ArrayList<ArrayList<Double>>();
		...
		// ArrayList<Double> vehicleArray =
		// JsonOutputWriter.createVehicleLine(vehicle);
...
//			System.out.println("here");
    ...
    /**
     * LZ: Returns the ArrayList representation of the given EV snapshot.
     * 
     * @param ev the ev snapshot to convert to arraylist.
     * @return the arraylist representation of the given vehicle snapshot.
     */
    public static ArrayList<Float> createEVLine(EVSnapshot ev){
    	if (ev == null) {
            return null;
        }
        ...
        vehicleArray.add((float)ev.getSpeed());
        vehicleArray.add((float)ev.getOriginID());
        vehicleArray.add((float)ev.getDestID());
//        vehicleArray.add((float)ev.getOriginX());
//        vehicleArray.add((float)ev.getOriginY());
//        vehicleArray.add((float)ev.getDestX());f
//        vehicleArray.add((float)ev.getDestY());
        vehicleArray.add((float)ev.getBatteryLevel());
...
//                nearlyArrived + "," + vehicleClass + "," + roadID);
    ...
    /**
     * LZ: Returns the ArrayList representation of the given Bus snapshot.
     * 
     * @param bus the bus snapshot to convert to arraylist.
     * @return the arraylist representation of the given vehicle snapshot.
     */
    public static ArrayList<Float> createBusLine(BusSnapshot bus){
    	if (bus == null) {
            return null;
        }
...
//                nearlyArrived + "," + vehicleClass + "," + roadID);
     ...
     * @return the arraylist representation of the given vehicle snapshot.
     */
    public static ArrayList<Float> createLinkLine(LinkSnapshot link){
    	if (link == null) {
            return null;
        }
        ...
        linkArray.add((float)link.getFlow());
        linkArray.add((float)link.getEnergy());
