...
File: IndexedGraphToAllIndexedGraphAdapter.java 
...
final class IndexedGraphToAllIndexedGraphAdapter<N extends GObject> implements IndexedGraph<N> {
  private final IndexedGraph<N> g;

  public IndexedGraphToAllIndexedGraphAdapter(IndexedGraph<N> g) {
    this.g = g;
  }
