...
File: IntGraphToObjectGraphAdapter.java 
...
final class IntGraphToObjectGraphAdapter<N extends GObject> implements ObjectGraph<N, Integer> {

  private final IntGraph<N> g;

  IntGraphToObjectGraphAdapter(IntGraph<N> g) {
    this.g = g;
  }
  ...
  @Override
  public boolean addEdge(GNode<N> src, GNode<N> dst, Integer data) {
    return g.addEdge(src, dst, data);
  }

  @Override
  public boolean addEdge(GNode<N> src, GNode<N> dst, Integer data, byte flags) {
    return g.addEdge(src, dst, data, flags);
  }

  @Override
  public Integer getEdgeData(GNode<N> src, GNode<N> dst) {
    return g.getEdgeData(src, dst);
  }

  @Override
  public Integer getEdgeData(GNode<N> src, GNode<N> dst, byte flags) {
    return g.getEdgeData(src, dst, flags);
  }

  @Override
  public Integer getEdgeData(GNode<N> src, GNode<N> dst, byte nodeFlags, byte dataFlags) {
    return g.getEdgeData(src, dst, nodeFlags);
  }

  @Override
  public Integer setEdgeData(GNode<N> src, GNode<N> dst, Integer d) {
    return g.setEdgeData(src, dst, d);
  }

  @Override
  public Integer setEdgeData(GNode<N> src, GNode<N> dst, Integer d, byte flags) {
